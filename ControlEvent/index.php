...
<!-- Hero Section Begin -->
    <section class="hero-section set-bg"  style="background-image: url(<?php echo get_theme_file_uri('img/hero.jpg')?> );" >
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-text">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ha-pic">
                         ...
                         <img src="<?php echo get_template_directory_uri().'/img/h-about.jpg'; ?>" class="img-fluid" alt="Responsive image"> 
